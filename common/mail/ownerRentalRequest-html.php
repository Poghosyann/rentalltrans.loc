...
<div style="width: 900px; margin:30px auto">
    ...
    <h1 style="text-align: center">Запрос на бронирование ТС</h1>
    <p>Уважаемый <?= $order->itemUser->first_name ?>,<br>
        Благодарим Вас за выбор сайта rentalltrans.com, мы рады сообщить Вам, что Ваше ТС предварительно бронировано, для  подтверждение или отмене бронирования Вашего ТС, просим зайти в Ваш аккаунт на сайте rentalltrans.com.
    </p>
    ...
    <div style="border: 1px solid; padding: 15px;">
	    ...
	    ?>
        <p>CASCO insurance: <span style="float: right">включая налоги AMD <?= $casco ?></span></p><hr>
